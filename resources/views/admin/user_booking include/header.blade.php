<div class="page-main-header">
    <div class="main-header-left" semilight-bg-color="bg-default-light-colo">
        <div class="logo-wrapper"><a href={{ route('home') }}><img src="/backend/assets/logo-light.png" class="image-dark"
                    alt=""><img src="/backend/assets/logo-light-dark-layout.png" class="image-light"
                    alt=""></a>
        </div>
    </div>
    <div class="main-header-right row" header-bg-color="bg-default-light-colo">
        <div class="mobile-sidebar col-1 ps-0">
            <div class="text-start switch-sm"><label class="switch"><input type="checkbox" id="sidebar-toggle"><span
